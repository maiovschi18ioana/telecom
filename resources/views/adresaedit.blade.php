...
<html>
  ...
  <body style='font-family: Arial; background-color: #cde8f9; font-size: 14px;'>
    ...
    <div class='container text-center'>
        ...
        <form class='text-left' id="edit-form" action="{{route('adresaedit',['idadresa' => $adresa->idadresa])}}" method='post' enctype="multipart/form-data">
        @csrf
          
        <div class="form-group">
                <label class='title'>Oras</label>
                <input type="text" id="oras" class="form-control" name='oras' value="{{$adresa->oras}}" >
            </div>
            
            <div class="form-group">
                <label class='title'>Strada</label>
                <input type="text" id="strada" class="form-control" name='strada' value="{{$adresa->strada}}" >
            </div>
               
            <div class="form-group">
                <label class='title'>Numar</label>
                <input type="text" id="numar" class="form-control" name='numar' value="{{$adresa->numar}}" >
            </div>
            
            <div class="form-group">
                <label class='title'>Apartament</label>
                <input type="text" id="apartament" class="form-control" name='apartament' value="{{$adresa->apartament}}" >
            </div>
