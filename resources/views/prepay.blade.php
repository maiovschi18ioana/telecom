  ...
  window.onload = function(){
    ...
    setInterval(function(){
      ...
      <div class="d-flex justify-content-between">
        ...
        <a href="{{route('subscriptie.form')}}" class='btn btn-lg btn-info my-4'>Adauga prepay</a>
      ...
      <table class="table table-sm px-0 " id='entry-table'>
          <thead>
              ...
              <th scope="col">Nr. prepay</th>
                  ...
                  <th scope="col">Credit disponibil</th>
          ...
          <tbody>
          @foreach($prepays as $index=>$prepay)
          
              <tr>
              
              <td>{{$prepay-> idprepay}}</td>
                  <td>{{$serviciu[$index]-> numeserviciu}}</td>
                  <td>{{$prepay-> creditdisponibil}}</td>
                  <td>
                
                <a href="/prepayedit/{{$prepay->idprepay}} "class='btn btn-md btn-info'>Editeaza</a>
                <a href="/stergereprepay?id={{$prepay->idprepay}}"class='btn btn-danger'>Delete</a>
