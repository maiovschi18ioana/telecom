  ...
  window.onload = function(){
    ...
    setInterval(function(){
      ...
      <div class="d-flex justify-content-between">
        ...
        <a href="{{route('subscriptie.form')}}" class='btn btn-lg btn-info my-4'>Adauga subscriptie</a>
      ...
      <table class="table table-sm px-0 " id='entry-table'>
          <thead>
              <tr>
              <th scope="col">Nr. subscriptie</th>
                  <th scope="col">Nr. Client</th>
                  <th scope="col">Nr. Abonament</th>
                  <th scope="col">Nr. Prepay</th>
                  <th scope="col">Nr. Contract</th>
                  <th scope="col">Nr. Telefon</th>
                  <th scope="col">Tip subscriptie</th>
          ...
          <tbody>
          @foreach($subscripties as $key => $subscriptie)
          
              <tr>
              
              <td>{{$subscriptie-> idsubscriptie}}</td>
                  <td>{{$subscriptie-> idclient}}</td>
                  <td>{{$subscriptie-> idabonament}}</td>
                  <td>{{$subscriptie-> idprepay}}</td>
                  <td>{{$subscriptie-> idcontract}}</td>
                  <td>{{$subscriptie-> idtelefon}}</td>
                  <td>{{$subscriptie-> tipsubscriptie}}</td>
                  <td>
                
                <a href="/subscriptieedit/{{$subscriptie->idsubscriptie}} "class='btn btn-md btn-info'>Editeaza</a>
                <a href="/stergeresubscriptie?id={{$subscriptie->idsubscriptie}}"class='btn btn-danger'>Delete</a>
