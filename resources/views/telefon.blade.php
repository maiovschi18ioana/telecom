  ...
  window.onload = function(){
    ...
    setInterval(function(){
      ...
      <div class="d-flex justify-content-between">
        ...
        <a href="{{route('adresa.form')}}" class='btn btn-lg btn-info my-4'>Adauga telefon</a>
      ...
      <table class="table table-sm px-0 " id='entry-table'>
          <thead>
              <tr>
              <th scope="col">Index telefon</th>
                  <th scope="col">Numar telefon</th>
                  <th scope="col">Data activare</th>
          ...
          @foreach($telefons as $key => $telefon)
              ...
              <td>{{$telefon-> idtelefon}}</td>
                  <td>{{$telefon-> numartelefon}}</td>
                  <td>{{$telefon-> dataactivare}}</td>
         
                 
                  <td>
                
                <a href="/telefonedit/{{$telefon->idtelefon}} "class='btn btn-md btn-info'>Editeaza</a>
                <a href="/stergeretelefon?id={{$telefon->idtelefon}}"class='btn btn-danger'>Delete</a>
